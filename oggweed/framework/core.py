...
class Application(object):
    ...
    Welcome to the OggWeed Application!
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    This class is the backbone of the OggWeed application: it knows
    ...
    def __init__(self, settings_path='oggweed.settings', *args, **kwargs):
        self.assets = None
    ...
    def from_env(CreateApplication,
                 environment_variable_name='OGGWEED_SETTINGS_MODULE',
                 fallback_module_name='oggweed.settings',
                 *flask_args,
                 **flask_kwargs
        ):

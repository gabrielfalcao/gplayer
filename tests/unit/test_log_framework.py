...
from bong.framework.log import (
    ColorFormatter,
...
@patch('bong.framework.log.settings')
@patch('bong.framework.log.logging')
...
@patch('bong.framework.log.settings')
@patch('bong.framework.log.logging')
@patch('bong.framework.log.ColorFormatter')
...
@patch('bong.framework.log.logging')
@patch('bong.framework.log.datetime')

...
from gplayer.framework.db import Model, metadata, get_redis_connection
from gplayer.framework.log import get_logger

from gplayer.framework.handy.functions import now


logger = get_logger('gplayer.web.models')
...
class Song(object):
    ...
    def from_filename(cls, filename):
        ...
        token = sha1(filename + today + 'gplayer').hexdigest()
        song_data = {
            'filename': filename,

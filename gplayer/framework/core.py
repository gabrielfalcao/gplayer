...
class Application(object):
    ...
    Welcome to the GPlayer Application!
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    This class is the backbone of the GPlayer application: it knows
    ...
    def __init__(self, settings_path='gplayer.settings', *args, **kwargs):
        self.assets = None
    ...
    def from_env(CreateApplication,
                 environment_variable_name='GPLAYER_SETTINGS_MODULE',
                 fallback_module_name='gplayer.settings',
                 *flask_args,
                 **flask_kwargs
        ):
